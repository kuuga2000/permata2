...
<div id="home-slide">
	<div id="home-slide-wrapper">
		...
		<a href="<?php echo $val->url;?>">
			<img src="<?php echo base_url('assets/upload/gallery/'.$val->img);?>" />
		</a>
			<?php if($ctr >= 5) { break; } ?>
			<?php
			}
...
<div id="home-left-column">
	<div id="have-a-question">
		...
		<a href="<?php echo base_url('contact-us')?>">
			<?php echo lang('global_havequestion.button', '');?> <img src="<?php echo base_url()?>assets/css/img/link-arrow.png" />
		</a>
	</div>
	...
	<div id="newsletter">
		...
		<?php echo form_close(); ?>
		<div class="cb"></div>
		<?php if ($this->session->flashdata('newsletter_subscribe')) echo '<br /><div class="errmsg">'.$this->session->flashdata('newsletter_subscribe').'</div>'; ?>
	</div>
...
<div id="home-right-column">
	...
	<div id="home-product-slide">
		...
		<div class="fleft"><h2>PRODUCT SALE</h2></div>
		...
		<div id="home-product-slide-wrapper">
				...
				<div class="home-product-slide-item <?php echo ($i == 1 ? "active":"");?>">
					<div class="fleft image">
						...
						<?php
						if($val_item->disc){ ?>
							<div class="ribbon"><?php echo $val_item->disc.$percent; ?></div>
						<?php } ?>						
					...
					<div class="fright information">
						<a href="<?php echo base_url('product/featured/sale/'.$val_item->alias);?>"><div class="add-to-bag">ADD TO BAG</div></a>
						<div class="cb" style="height:20px;"></div>
						
						<div class="title"><?php echo $val_item->name;?></div>
						<div class="code">CODE : <?php echo $val_item->code;?></div>
						...
						<div class="price">
							<div class="fleft discount-percent">
								...
								<div class="percentage"><?php echo $val_item->disc.' '.$percent;?></div>
							</div>
							<div class="fleft nett-price">
								<div class="title">PRICE</div>
								<span class="currency">IDR</span>
								<span class="price1"><?php echo substr($val_item->base_price, 0, strlen($val_item->base_price)-3);?></span>
								<span class="price2">.<?php echo substr($val_item->base_price, -3);?></span>
								<div class="cb"></div>
							</div>
						</div>
					</div>
...
<div id="home-product-clearance" class="body-wrapper">
	<div class="fleft"><h2>CLEARANCE PRODUCT</h2></div>
				...
				<div class="home-product-clearance-group">
					...
					<a href="<?php echo base_url('product/featured/clearance/'.$item->alias);?>">
						<div class="home-product-clearance-item <?php echo ($ctr % 5 == 0? "last":"");?>">	
							<div class="image"><img src="<?php echo base_url('assets/upload/product/m/'.$photo);?>" /></div>
							<?php if($item->disc){ ?><div class="price-original">IDR <?php echo number_format($item->base_price,0,'','.')?></div> <?php } ?>
							<div class="price-nett">
								<div class="currency">IDR</div> 
								<div class="price1"><?php echo number_format(substr($discprice, 0, strlen($discprice)-3),0,'.','.');?></div>
							...
							<div class="short-desc"><?php echo ((strlen($val_item->deskripsi) <= 100) ? $val_item->deskripsi : substr($val_item->deskripsi, 0, 90)."..");?></div>
					...
					<?php if($ctr % 5 == 0) {?>
					<div class="cb"></div>
				</div> <!-- end of .home-product-clearance-group -->
				<?php }?>
